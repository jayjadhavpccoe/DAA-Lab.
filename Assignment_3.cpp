...
int main() {
    ...
    items.emplace_back("Food", 12.0, 450.0, true);
    items.emplace_back("Charger", 5.0, 350.0, false);
    items.emplace_back("Tents", 25.0, 600.0, false);
    items.emplace_back("Table", 18.0, 300.0, true);
